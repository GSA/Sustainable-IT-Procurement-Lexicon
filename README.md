...
To download the lexicon, please click on the "Code" button on the top right of the page, and then select "Download ZIP" from the dropdown menu. Alternatively, you can click [here](https://github.com/GSA/Sustainable_IT_Procurement_Lexicon/archive/refs/heads/main.zip).
